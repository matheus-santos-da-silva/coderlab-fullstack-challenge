...
describe("Delete Product Controller (e2e) - (DELETE /product/:id)", () => {
  ...
  it("should return 200 status code when delete a product", async () => {
  ...
  it("should return 400 status code when try delete a product that id not exists", async () => {
    await request(app.getHttpServer())
